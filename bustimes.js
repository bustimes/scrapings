...
var AFM_page = new AFMpageManager;
{
    ...
    AFM_getParameterByName("testpage") && AFM_page.path.push(AFM_getParameterByName("testpage")),
        ...
        function() {
            var e = document.createElement("script");
            e.type = "text/javascript", e.async = !0, e.src = "https://cdn.adfirst.media/hb/pb_8450b_bt.js";
            var t = document.getElementsByTagName("head")[0];
            t.insertBefore(e, t.firstChild)
        }();
    ...
    0 <= afm_hour && afm_hour <= 6 ? refreshPeriod = 2e4 : 7 <= afm_hour && afm_hour <= 8 ? refreshPeriod = 18e3 : 9 <= afm_hour && afm_hour <= 14 ? refreshPeriod = 22e3 : 16 <= afm_hour && afm_hour <= 18 && (refreshPeriod = 2e4);
        ...
        AMfooterOn && pbjs.onEvent("bidWon", function(e) {
            ...
            rubicon: {
                bidCpmAdjustment: function(e) {
                    return e * makeNet85 * usdRate * .99
                }
            },
            improvedigital: {
                bidCpmAdjustment: function(e) {
                    return e * makeNet86 * usdRate * .99
                }
            },
            sovrn: {
                bidCpmAdjustment: function(e) {
