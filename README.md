...
- bustimes.org's advertising script ([bustimes.js](bustimes.js))
  - using [webcrack](https://github.com/j4k0xb/webcrack) to reverse some minification
...
- the national public transport access nodes (NaPTAN) bus stops list ([naptan/](naptan))[^1]
  - using [qsv](https://github.com/dathere/qsv) to partition the data by AdministrativeAreaCode so it's not one big file
